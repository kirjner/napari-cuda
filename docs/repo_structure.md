...
- Server runtime package introduced (`server/runtime/egl_worker.py`, `runtime/worker/loop.py`, `runtime/render_update_mailbox.py`, `runtime/core/*`), isolating orchestration from rendering helpers.
