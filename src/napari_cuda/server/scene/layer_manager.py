...
class ViewerSceneManager:
    ...
    def _snapshot_worker(
        ...
        *,
        ...
        viewport_state = worker.viewport_state  # type: ignore[attr-defined]
        ...
        if mode is RenderMode.PLANE and viewport_state.plane.applied_step is not None:
        ...
        is_volume = bool((mode is RenderMode.VOLUME) or (ndisplay_val >= 3))
