...
def test_apply_slice_level_updates_plane_state(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setattr(
        "napari_cuda.server.runtime.render_loop.apply.render_state.plane.plane_wh_for_level",
        _fake_plane_wh,
    )
    monkeypatch.setattr(
        RenderApplyInterface,
    ...
    monkeypatch.setattr(
        "napari_cuda.server.runtime.render_loop.apply.render_state.plane.apply_slice_roi",
        _fake_apply,
    )
