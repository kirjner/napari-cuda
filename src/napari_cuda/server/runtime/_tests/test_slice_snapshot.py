...
def test_apply_slice_level_updates_plane_state(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setattr(
        "napari_cuda.server.runtime.render_loop.apply.snapshots.plane.plane_wh_for_level",
        _fake_plane_wh,
    )
    monkeypatch.setattr(
    ...
    monkeypatch.setattr(
        "napari_cuda.server.runtime.render_loop.apply.snapshots.plane.apply_slice_roi",
        _fake_apply,
    )
